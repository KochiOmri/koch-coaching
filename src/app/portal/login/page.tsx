      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm" style={{ color: "var(--muted)" }}>
            Access your training, track progress, and book sessions
          </p>
        </div>
        ...
        >
          ...
          {/* Tabs */}
          <div className="mb-5 flex rounded-xl border" style={{ borderColor: "var(--card-border)" }}>
        ...
        <div className="mt-6 flex items-center justify-center gap-4">
          <a href="/" className="text-sm transition-colors hover:underline" style={{ color: "var(--muted)" }}>
            ← Back to website
          </a>
          <span style={{ color: "var(--card-border)" }}>|</span>
          <a href="/admin/login" className="text-sm transition-colors hover:underline" style={{ color: "var(--muted)" }}>
            Admin login
          </a>
        </div>
      </div>
